...
export default function TodoItem({ todo }) {
    ...
    const toggleCompleted = () => {
        console.log("toggled: ", todo.isCompleted);
        toggleTodo(todo.id);
    }
    ...
    return (
        <div className={`flex border border-black/10 rounded-lg px-3 py-1.5 gap-x-3 shadow-sm shadow-white/50 duration-300 text-black ${todo.isCompleted ? "bg-[#c6e9a7]" : "bg-[#ccbed7]"}`}>
            <input
                type="checkbox"
